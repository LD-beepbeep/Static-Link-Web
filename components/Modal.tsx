...
const Modal: React.FC<ModalProps> = ({ isOpen, onClose, title, children, footer }) => {
  ...
  return (
    ...
    >
      <div
        className="bg-white dark:bg-slate-800 rounded-lg shadow-2xl w-full max-w-md m-4 transform transition-all"
      ...
      >
        ...
        {footer && (
          <div className="flex justify-end gap-3 p-4 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-200 dark:border-slate-700 rounded-b-lg">
            {footer}
          </div>
        )}
      </div>
